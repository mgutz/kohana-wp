 ...
 */
$application = get_option('kwp_application_path');
...
require get_option('kwp_system_path') . 'classes/kohana/core' . get_option('kwp_ext');
...
#}
    ...
    require get_option('kwp_system_path') . 'classes/kohana' . get_option('kwp_ext');
#}
